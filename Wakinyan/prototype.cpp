...
//
//	//Open the font
//	gFont = TTF_OpenFont("Assets/Other/lazy.ttf", 28);
//	if (gFont == NULL)
//	{
...
//	SDL_RWops* file = SDL_RWFromFile("Assets/Other/nums.bin", "r+b");
//
//	//File does not exist
//	if (file == NULL)
//	{
...
//		file = SDL_RWFromFile("Assets/Other/nums.bin", "w+b");
//		if (file != NULL)
//		{
...
//	SDL_RWops* file = SDL_RWFromFile("Assets/Other/nums.bin", "w+b");
//	if (file != NULL)
//	{
//		//Save data
//		for (int i = 0; i < TOTAL_DATA; ++i)
